<div>
    ...
    <link rel="stylesheet" href="App/View/plantillapublic.css">
        ...
        <div class="container mx-auto px-4">
            ...
            <a href="http://localhost/Carpeta%20proyecto/TenisPersonalizados/?C=ProductosController&M=Productos" class="mt-6 inline-block bg-indigo-500 text-white px-6 py-3 rounded-lg hover:bg-indigo-600">Ver productos</a>
        </div>
    </header>
